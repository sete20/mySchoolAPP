                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select name="status" id="" class="select2Fe form-control">
                                <option value="1" @if($subscription->status == 1  ) selected @endif>{{ __('lesson..type_active') }}</option>
                                <option value="0"  @if($subscription->status == 0  ) selected @endif >{{ __('lesson..type_deactive') }}</option>
                            </select>
                        </div>
                    </div>
                             <div class="col-6">
                        <div class="form-group">
                            <label for="duration">{{ __('lesson..duration_months') }}</label>
                              <input class="form-control" value="{{ $subscription->duration }}" type="number" name="duration" >
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="duration">{{ __('lesson..units') }}</label>
